package com.lastwhispers.harness.ch05;

import com.lastwhispers.harness.ch05.engine.AgentEngine;
import com.lastwhispers.harness.ch05.provider.DashScopeProvider;
import com.lastwhispers.harness.ch05.provider.LLMProvider;
import com.lastwhispers.harness.ch05.tools.ReadFileTool;
import com.lastwhispers.harness.ch05.tools.Registry;
import com.lastwhispers.harness.ch05.tools.RegistryImpl;
...
public class Main {
    public static void main(String[] args) {
        ...
        // 1. 获取工作区物理边界
        String workDir = System.getProperty("user.dir")+"/workspace/ch05";
